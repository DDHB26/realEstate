...
export const { signInStart, signInSuccess, signInFail, updateAvatar, updateUserFailure,updateUserStart,updateUserSuccess,deleteUserFailure,deleteUserSuccess,deleteUserStart } = userSlice.actions;
